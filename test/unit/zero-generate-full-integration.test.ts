...
// P5-69 (2026-05-04): INSERT 直前ガード (100 char 未満 throw) を超えるよう拡張。
const TONE_NG_BODY_HTML =
  '<h2>テスト</h2>' +
  '<p>"これは引用です"。</p>' +
  '<p>普通の段落です。今日はとても穏やかな一日でしたね。</p>' +
  '<p>本文の内容は、あくまで検査用のサンプルです。' +
  'ダブルクォートを混ぜることでトーン検証 NG をテストしています。</p>';
...
const SPIRITUAL_BODY_HTML =
  ...
  '<p>朝の光のなかで深呼吸をすれば、心の輪郭がやわらかく整います。</p>';
