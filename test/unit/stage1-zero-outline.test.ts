...
const VALID_OUTLINE: ZeroOutlineOutput = {
  ...
  // P5-99: kishotenketsu 必須化に伴い追加。各 phase は 50〜150 字、ten_perspective_shift は 20〜120 字。
  kishotenketsu: {
    ki: 'ペットを失った朝、世界から色が消えたように感じられ、何をしても心にあいた穴が埋まらない静かな日々が、ただ淡々と過ぎていきました。',
    sho: '悲しみは消えるどころか、ふとした瞬間に形を変えて立ちあらわれ、忘れたいのに忘れたくないという矛盾した気持ちが胸の奥でゆらいでいました。',
    ten: '悲しみを消すべきものとして扱うのをやめてみると、それはあの子と過ごした時間の確かな証であり、愛の続きなのだと視点が静かに反転しました。',
    ketsu: '思い出はいまも一緒に呼吸している。悲しみごと抱きしめながら、今日はひとつだけ深呼吸する。その小さな一歩から、またゆっくり歩きはじめられます。',
    ten_perspective_shift:
      '「悲しみを消す」から「悲しみごと愛を抱きしめる」へ、対象への向き合い方そのものを反転させた。',
  },
};
